...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@Debug/Profiler/dump.html.twig", "/home/etudiant/Documents/projet-o-cooking/backend-ocooking/vendor/symfony/debug-bundle/Resources/views/Profiler/dump.html.twig");
    }
}
